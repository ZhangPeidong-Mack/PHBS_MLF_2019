...
## Data Description
We use trading data obtained from JQ-Quant Database from 2017-01-01 to 2019-12-31. Features include the opening price, closing price, highest price, lowest price, trading volume and turnover. The dataset is too large so we cannot upload it as a whole. Instead, we divided it into two parts: [data_part1.csv](https://github.com/ZhangPeidong-Mack/PHBS_MLF_2019/tree/master/data/data_part1.csv) and [data_part2.csv](https://github.com/ZhangPeidong-Mack/PHBS_MLF_2019/tree/master/data/data_part2.csv). Click [here](https://pan.baidu.com/s/1aaYOzaOtSxtKzsZU-PMNlg) with extraction code "nspy" if you want to see a complete version of our data. 
